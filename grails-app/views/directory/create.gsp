                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:directoryInstance,field:'path','errors')}">
                                    <input type="text" id="path" name="path" value="${fieldValue(bean:directoryInstance,field:'path')}"/>
                                </td>
                            </tr> 
